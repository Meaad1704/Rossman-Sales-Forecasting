...
if page == "XGBoost Prediction":
    ...
    # Load the XGBoost model from GitHub using caching
    @st.cache_resource
    def load_model():
        model_url = "https://github.com/Meaad1704/Rossman-Sales-Forecasting/raw/main/xgboost_model.pkl"
        try:
            ...
            st.error("Error loading model. Please check the model path and your internet connection.")
            st.stop()

    # Load model and confirm success
    model = load_model()
    st.write("Model loaded successfully!")

    # When button is pressed, predict sales with the model
